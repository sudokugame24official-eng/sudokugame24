...
export class KnowledgeController {
  ...
  async createTechnique(@Body() data: any) {
    return this.knowledgeService.createTechnique(data);
  }
  ...
  async updateTechnique(@Param('id') id: string, @Body() data: any) {
    return this.knowledgeService.updateTechnique(id, data);
  }
